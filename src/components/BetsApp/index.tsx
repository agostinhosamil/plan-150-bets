...
import { formatCurrency } from "@verdantkit/utils";
    ...
    <Fragment>
      ...
      {bets
        ...
        .map((bet) => {
          ...
          return (
            <div key={bet.id} className="w-full flex flex-col gap-5 max-w-4xl">
                    ...
                    {betCalendar.map((betDay, i) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <CopyableText data={balanceToString(betDay.balance)}>
                            <span
                              className={cn(
                      ...
                      return (
                        ...
                        >
                          <div className="w-full flex justify-center flex-row gap-2">
                            Day #{betDay.number} (
                            {calcFutureDate(betDay.number, bet.createdAt)}), You{" "}
                            {won
                              ? "won:"
                          ...
                          <div className="w-full flex flex-col [&>span]:border-y [&>span]:border-solid [&>span]:border-zinc-500 [&>span]:p-6 [&>span]:font-extrabold">
                            ...
                            <span>
                              ...
                              {String(Math.ceil(bet.days / 30)).concat(
                                Math.ceil(bet.days / 30) >= 2 ? " meses" : "mês"
                              )}
                              ) -{" "}
