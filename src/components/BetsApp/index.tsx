...
export const BetsApp = () => {
  ...
  const CreateBetDialog = () => {
    ...
    const buttonClickHandler = () => {
      const values = [days, betsPerDay, initialBalance];
          ...
          <div key={id} className="w-full flex flex-col gap-5 max-w-4xl">
                  ...
                  {range(0, totalBets).map((i) => {
                    ...
                    return (
                      <li
                        ...
                        className={cn(
                          "w-full md:w-1/3 lg:w-5 xl:w-1/6 relative flex flex-col gap-4 text-center flex-grow bg-zinc-900 hover:bg-zinc-800 active:bg-zinc-700 active:scale-105 transition-all cursor-pointer rounded-lg p-6 justify-center items-center",
                      ...
                      >
                        ...
                        <strong
                          className={cn(
                            "text-white uppercase pointer-events-none select-none",
                            balance >= 1_000_000
            ...
            <div className="w-full flex flex-row items-center justify-between gap-5 fixed m-auto max-w-4xl rounded-md shadow-xl bg-zinc-800 select-none p-4 bottom-9">
              <h4 className="text-xl font-extrabold">
                Balance: {formatCurrency(bet.balance, "AKZ")}
              </h4>
